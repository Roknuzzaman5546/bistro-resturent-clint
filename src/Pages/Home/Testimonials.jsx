                ...
                <Swiper navigation={true} modules={[Navigation]} className="mySwiper">
                    {
                        testimonials.map(item => <SwiperSlide
                            key={item._id}
                        >
                            <div className="px-20 py-10 flex items-center flex-col">
                                <Rating
                                    style={{ maxWidth: 180 }}
                                    value={item.rating}
                                    readOnly
                                />
                                <svg xmlns="http://www.w3.org/2000/svg" className="mt-4" width="100" height="80" viewBox="0 0 100 100" fill="none">
                                ...
                                <h2 className=" text-2xl uppercase text-yellow-600">{item.name}</h2>
                            </div>
                        </SwiperSlide>)
                    }
                </Swiper>
